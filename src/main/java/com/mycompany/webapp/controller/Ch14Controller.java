...
public class Ch14Controller {
	...
	public void jsonresponse1(HttpServletResponse response) throws Exception {
		response.setContentType("appliaction/json;charset=UTF-8"); //보내고자 하는 타입;문자열
	...
	/*
	 * @GetMapping("/employee") public String employee(int employee_id) {
	 * Ch14Employee emp = employeeService.getEmployee(employee_id);
	 * logger.info("employee_id: " + emp.getEmployee_id());
	 * logger.info("first_name: " + emp.getFirst_name()); logger.info("last_name: "
	 * + emp.getLast_name()); return "ch14/content"; }
	 */
	...
	public void battach(int bno, HttpSession session, HttpServletResponse response) throws Exception {
		...
		filePath = "D:/MyWorkspace/uploadfiles/boards/" + battachsname;
