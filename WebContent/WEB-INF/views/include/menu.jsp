...
<div class="menu">
	<ul>
		...
		<li class="chapter">Ch08. <a href="<%=application.getContextPath()%>/ch08/content">Data Delivery(Using Session)</a></li>
		...
		<li class="chapter">Ch14. <a href="<%=application.getContextPath()%>/ch14/content">Data Access(Data Access Object)</a></li>
	</ul>			
</div>