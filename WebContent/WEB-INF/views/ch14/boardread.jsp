			...
			<div class="mainCenter">
				...
				<div class="content">
					<div class="sector">
						...
						<form class="boardwriteform" action="boardwrite" method="post">
							...
							<div class="form-group">
							    ...
							    <c:if test="${board.battachsname != null}">
							    	...
							    	<a class="btn btn-light ml-2" href="battach?bno=${board.bno}">다운로드</a>
							    </c:if>
							 </div>
							<div class="form-group">
						  ...
						  <c:if test="${sessionMid == board.bwriter}">
							  <a class="btn btn-outline-light btn-sm" href="boardupdate?bno=${board.bno}">수정</a>
							  <a class="btn btn-outline-light btn-sm" href="boarddelete?bno=${board.bno}">삭제</a>
						  </c:if>
						</form>
					</div>
				</div>
